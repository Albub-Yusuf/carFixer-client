    ...
    return (
        <section>
            <Container>
                ...
                <Row mt-5 pt-5>
                    <br></br>
                    <Col mt-5 pt-5 md={6} sm={6} xs={12} d-flex style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
                        <img classname="image" style={{ width: '450px', borderRadius: '15px', padding: '10px' }} src={mechanic}></img>
                    </Col>

                    <Col md={6} sm={6} xs={12} style={{ display: 'flex', justifyContent: 'center' }}>
